...
export const metadata: Metadata = {
  ...
  description:
    'Backend and systems engineer in Bangalore, graduating May 2027. Six projects, one page: a JIT regex engine, a garbage collector that predicts object lifetimes, an overload-aware gateway, and a skin lesion classifier whose evaluation I audited and rebuilt.',
  openGraph: {
    title: `${profile.name}, ${profile.headline}`,
